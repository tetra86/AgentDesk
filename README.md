...
- **[claw-empire](https://github.com/itismyfield/claw-empire)** (MIT License) — Kanban pipeline, dispatch system, GitHub synchronization, and dashboard UI components were originally developed in claw-empire.
